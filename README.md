...
**Забележка: в момента ECDC са в процес на смяна на формата на данните си--изглежда ми, че всички набори минават от дневена на седмична резолюция, заедно с някои други промени, но процесът не е в една стъпка и липсва документация, така че тази част от скриптовете (`demo.R`) може да заварите неработещи.**
